  ...
  <div class="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        ...
        <p
          class="max-w-md mx-auto mt-6 leading-relaxed text-center  sm:max-w-xs sm:mx-0 sm:text-left"
        >
        ...
        <ul class="flex justify-center gap-6 mt-8 md:gap-8 sm:justify-start">
          <li>
            <a
              ...
              target="_blank"
              class="text-primary transition hover:text-primary/75"
            >
    ...
    <div class="pt-6 mt-12 border-t border-gray-100">
      <div class="text-center sm:flex sm:justify-between sm:text-left">
        <p class="text-sm">
          ...
          <a
            class="inline-block text-primary underline transition hover:text-primary/75"
            href="/"
          >
            Terms & Conditions
          </a>
